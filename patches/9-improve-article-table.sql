...
SELECT _v.register_patch( '9-improve-article-table', ARRAY['8-authdb.ddl','7-author_article_journal_web_views'], NULL );
...
ALTER TABLE core.articles DROP CONSTRAINT articles_id_code_fkey;
