...
/*
select label, lme_name,lme_dist_m
  from osdregistry.sample_environmental_data
 where local_date between '2014-03-01' AND '2014-08-01'
;
--*/

select label, local_date, start_date_time_utc, end_date_time_utc,lme_name,lme_dist_m
  from osdregistry.sample_environmental_data
 where local_date between '2014-03-01' AND '2014-08-01'
 and osd_id in (71);
