...
INSERT INTO core.ribosomal_sequences (sequence, size, gc, data_source, retrieved, project, own, did, did_auth, mol_type, acc_ver, isolate_id, gpid, center, status, seq_platform, seq_approach, seq_method, study, sample_name, isolate_name, estimated_error_rate, calculation_method)
  SELECT sequence, size, gc, data_source, retrieved, project, own, did, did_auth, mol_type, acc_ver, isolate_id, gpid, center, status, seq_platform, seq_approach, seq_method, study, sample_name, isolate_name, estimated_error_rate, calculation_method FROM silva.ribosomal_sequences_mat WHERE NOT EXISTS (
